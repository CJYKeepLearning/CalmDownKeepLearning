    ...
    class Card
    {
        ...
        class Test3_1
        {
            static void Main(string[] args)
            {
                ...
                Console.Write("请选择按什么关键字排序（1.按书名，2.按作者,3按入库量)");
                sline = Console.ReadLine();
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        T.sortTitle(books, index); break;

                    case 2:

                        T.sortAuthor(books, index); break;

                    case 3:

                        T.sortTotal(books, index); break;
                }
                */
            ...
            void sort(Card[] book, int[] index, int method)
            {
                ...
                {
                    sortAuthor(book, index);
                }
                else if(method == 3)
                {
                    sortTotal(book, index);
                }
                else
                {
