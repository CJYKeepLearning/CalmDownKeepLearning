...
namespace Experiment2_4
{
    class CRect
    {
        private int top, bottom, left;
        private int right;
        ...
        public CRect()
        {
            ...
            Console.WriteLine("Total retangle areas is: {0}", total_rects);
        }
        ...
        public CRect(int x1, int y1, int x2, int y2)
        {
            ...
            Console.WriteLine("CRect(int,int,int,int) Constructing rectangie number {0} ", total_rects);
        ...
        public CRect(CRect r)
        {
            ...
            Console.WriteLine("CRect(CRect&) Constructing recagle number {0}", total_rects);
            Console.WriteLine("Total rectangle areas is: {0}", total_rect_area);
