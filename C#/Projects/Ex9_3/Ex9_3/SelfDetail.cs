...
namespace Ex9_3
{
    public partial class SelfDetail : Form
    {
        ...
        {
            this.BindingContext[mDataSet,"SelfIfo"].Position = 0;
            ButtonStateControl();
        }

        private void btnPrev_Click(object sender, EventArgs e)
        {
            this.BindingContext[mDataSet, "SelfIfo"].Position += 1;
            ButtonStateControl();
        }
        ...
        {
            this.BindingContext[mDataSet, "SelfIfo"].Position = this.BindingContext[mDataSet,"SelfInfo"].Count-1;
            ButtonStateControl();
        }
    }
}
